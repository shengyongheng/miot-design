...
class MHCard extends React.Component {
  ...
  renderInnerView() {
    ...
    return <View style={[styles.container, this.radiusStyle, opacityStyle, this.props.style]} {...getAccessibilityConfig({
      ...
      name: 'activate'
        ...
        }, this.props.iconStyle]} source={this.props.icon} resizeMode="contain" {...getAccessibilityConfig({
          accessible: false
        })} />
        </View>
  ...
  renderRight() {
    if (this.props.cardType === CARD_TYPE.NORMAL) {
      ...
      }]} source={Images.common.right_arrow} resizeMode="contain" {...getAccessibilityConfig({
        accessible: false
      })} />;
    }
