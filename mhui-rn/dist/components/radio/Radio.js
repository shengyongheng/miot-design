...
class Radio extends Component {
  ...
  colorSwitchCircle = new DynamicColor('#ffffff', 'rgba(255,255,255,0.90)');
  ...
  render() {
    ...
    let colorSmallCircleBg = smallCircleBg || this.colorSwitchCircle.color(colorScheme);
