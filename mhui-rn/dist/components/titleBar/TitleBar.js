  ...
  render() {
    ...
    return <SafeAreaView style={[containerStyle, this.props.style, containerHeight]}>
        ...
        {this.props.rightText ? <View>
              <RkButton onPress={this.props.onPressRight} contentStyle={[leftRightTextStyle, this.props.rightTextStyle]} style={[leftRightTextStyle, {
          ...
          accessibilityHint: this.props.rightAccessibilityHint
              ...
              {this.props.showDot && <Image style={[styles.dot]} resizeMode="contain" source={message} />}
            </View> : <View>
              <ImageButton onPress={this.props.onPressRight} style={[styles.img, {
