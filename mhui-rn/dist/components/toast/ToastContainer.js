...
import { ViewPropTypes, StyleSheet, View, Text, Animated, Dimensions, TouchableWithoutFeedback, Easing, Keyboard } from 'react-native';
...
class ToastContainer extends Component {
    ...
    if (!this._animating) {
      ...
      Animated.timing(this.state.opacity, {
        ...
        if (finished) {
          ...
          this.props.onShown && this.props.onShown(this.props.siblingManager); // if (this.props.duration > 0) {
  ...
  render() {
    ...
    return this.state.visible || this._animating ? <View style={[styles.defaultStyle, position]} pointerEvents="box-none">
        ...
        }]} pointerEvents="none" ref={ele => this._root = ele}>
                    <Text style={[styles.textStyle, props.textStyle, props.textColor && {
