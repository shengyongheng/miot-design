...
export function useTheme(props) {
  ...
  const themeStylesMemo = useMemo(() => mergeWith(themeStyles(theme), styles, customizer),
...
export function WithTheme(props) {
  ...
  // eslint-disable-next-line prettier/prettier
  [themeStyles, styles]);
  return /*#__PURE__*/React.createElement(ThemeContext.Consumer, null, theme => children(getStyles(theme), theme));
}
